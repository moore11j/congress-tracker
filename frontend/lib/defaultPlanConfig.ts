...
const featureDefinitions: FeatureDefinition[] = [
  ...
  },
  {
    ...
    kind: "feature",
    description: "Options flow overlay and feed access. Coming soon where provider data is not yet enabled.",
    required_tier: "premium",
    unit_singular: "",
    unit_plural: "",
    sort_order: 100,
  ...
  },
  {
    ...
    kind: "feature",
    description: "Institutional activity feed access. Coming soon where provider data is not yet enabled.",
    required_tier: "pro",
    unit_singular: "",
    unit_plural: "",
    sort_order: 110,
