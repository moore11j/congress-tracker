...
test("Google connection discloses scope, missing volume and review-only feedback", () => {
  for (const text of ["Read-only access", "No Gmail or Drive access", "Keyword Planner search volumes: not connected", "never automatically rewritten or republished", "Sync performance now", "window.confirm"]) assert.ok(ui.includes(text));
});
