      ...
      <body className="min-h-full">
        <div className="relative min-h-screen min-w-0 max-w-full">
          ...
          <header className="relative z-[1000] border-b border-white/10 bg-slate-950/80 backdrop-blur">
            <div className="mx-auto flex w-full min-w-0 max-w-[1728px] flex-wrap items-center justify-between gap-x-3 gap-y-2 px-4 py-2 sm:px-6 lg:flex-nowrap lg:gap-x-6 lg:gap-y-1 lg:px-8 lg:py-2.5 xl:gap-x-8 2xl:px-10">
