...
const faqs = [
  ...
  { question: "Can I use a historical portfolio return?", answer: "You can import available annualized strategy or institutional returns, or run the existing backtester for a Congress member. Congress returns model a disclosure-date strategy with 90-day holds and monthly rebalancing, not the member’s actual account. Backtests require sign-in and an eligible plan. The source, period, and assumptions are shown before applying a return. Insiders are not currently offered. Historical returns are illustrative assumptions, not predictions." },
