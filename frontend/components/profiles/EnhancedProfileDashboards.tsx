...
export function EnhancedInstitutionDashboard({ data, period }: { data: InstitutionsOverviewResponse; period: string }) {
  ...
  return <ProfileDashboard
    ...
    secondary={{ title: "Top increased positions", rows: data.position_changes, columns: [["symbol", "Ticker", "link"], ["company", "Company"], ["current_value", "Current value", "currency"], ["previous_value", "Previous value", "currency"], ["increase", "Increase", "currency"]] }}
    sectorRows={data.sector_exposure}
    sectorTitle="Sector exposure over time"
    left={{ title: "Most widely held stocks", rows: data.most_widely_held, columns: [["symbol", "Ticker", "link"], ["company", "Company"], ["total_value", "Total value", "currency"], ["institution_count", "Institutions", "number"]] }}
