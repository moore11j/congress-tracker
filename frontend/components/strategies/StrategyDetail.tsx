...
export function StrategyDetail({ strategy, period }: Props) {
  ...
  return <div className="space-y-4 py-3 sm:py-5">
    <section className="flex flex-wrap items-start justify-between gap-4">
      ...
      <div className="flex flex-wrap gap-2"><Link href="/strategies/methodology" className="rounded-md border border-white/15 px-3 py-2 text-sm font-semibold text-slate-100 hover:border-emerald-300/40">Methodology</Link>{statusLive ? <button disabled className="rounded-md bg-emerald-400/15 px-3 py-2 text-sm font-semibold text-emerald-100 ring-1 ring-emerald-300/30">Following unavailable</button> : <span className="rounded-md border border-white/10 px-3 py-2 text-sm font-semibold text-slate-400">Historical strategy</span>}</div>
    </section>
