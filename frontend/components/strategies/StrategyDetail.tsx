  ...
  return <div className="space-y-4 py-3 sm:py-5">
    <section className="flex flex-wrap items-start justify-between gap-4">
      <div className="min-w-0">
        ...
        <h1 className="mt-2 text-3xl font-semibold text-white">{strategy.name}</h1>
      ...
      <div className="flex flex-wrap gap-2">
        ...
        {canFollow ? <StrategyFollowButton slug={strategy.slug} compact /> : <span className="rounded-md border border-white/10 px-3 py-2 text-sm font-semibold text-slate-400">Historical strategy</span>}
      </div>
    </section>
    ...
    <section className="grid gap-3 sm:grid-cols-2 xl:grid-cols-6">
      {[
        ...
        ["Status", statusLive ? "Live" : "Historical", statusLive ? "text-emerald-300" : "text-sky-200"],
