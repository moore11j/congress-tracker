export function FeedShellFallback() {
  return (
    <section className="flex flex-col gap-3">
      ...
      <div className="mx-auto mt-5 grid w-full max-w-2xl gap-3 rounded-lg border border-emerald-300/25 bg-slate-950/80 p-2 shadow-2xl shadow-black/25 ring-1 ring-white/10 sm:mt-8 sm:grid-cols-[1fr_auto]">
      ...
      <div className="mt-5 flex flex-col items-center gap-2 text-center sm:mt-6 lg:mt-7">
