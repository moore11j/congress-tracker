...
def stock_screener(
    ...
    institutional_activity_type: str | None = Query(None, pattern="^(accumulation|distribution|new_position|exit|major_holder_move|cluster_move)$"),
    ...
    institutional_activity_min_ownership_pct: float | None = Query(None, ge=0),
    institutional_activity_holder_breadth: str | None = Query(None, pattern="^(net_3|net_10|increasing_10|increasing_25)$"),
    institutional_activity_lookback: str | None = Query(None, pattern="^(30d|90d|latest_quarter|1y)$"),
    institutional_activity_lookback_days: int = Query(30, ge=1, le=365),
    analyst_consensus_active: bool | None = None,
    analyst_consensus_direction: str | None = Query(None, pattern="^(bullish|bearish|neutral)$"),
    analyst_consensus_min_upside: float | None = None,
    analyst_consensus_min_ratings: int | None = Query(None, ge=0),
    analyst_consensus_max_dispersion: float | None = Query(None, ge=0),
    ...
    params = _build_screener_params(
        ...
        institutional_activity_type=institutional_activity_type,
        ...
        institutional_activity_min_ownership_pct=institutional_activity_min_ownership_pct,
        institutional_activity_holder_breadth=institutional_activity_holder_breadth,
        institutional_activity_lookback=institutional_activity_lookback,
        institutional_activity_lookback_days=institutional_activity_lookback_days,
        analyst_consensus_active=analyst_consensus_active,
        analyst_consensus_direction=analyst_consensus_direction,
        analyst_consensus_min_upside=analyst_consensus_min_upside,
        analyst_consensus_min_ratings=analyst_consensus_min_ratings,
        analyst_consensus_max_dispersion=analyst_consensus_max_dispersion,
