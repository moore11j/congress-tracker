...
DEFAULT_TEMPLATES: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "name": "Watchlist monitoring digest",
        "category": "alerts",
        "from_name": ALERTS_FROM_NAME,
        "from_email": ALERTS_FROM_EMAIL,
        "reply_to": SUPPORT_EMAIL,
        "subject": "Walnut watchlist monitoring digest",
        "preheader": "Daily summary of selected monitoring alerts for your watchlist.",
        "variables": ["first_name", "watchlist_name", "digest_date", "summary", "items_text", "items_html", "digest_url"],
        "body_text": walnut_email_text(
            greeting="Hello {{first_name}},",
            intro="Your Walnut monitoring digest for {{watchlist_name}} is ready for {{digest_date}}.",
            sections=[
                "{{summary}}",
                "{{items_text}}",
        ...
        "body_html": walnut_email_html(
            ...
            title="{{watchlist_name}} monitoring digest",
    ...
    },
    {
        ...
        "variables": ["first_name", "watchlist_name", "summary", "items_text", "items_html", "market_news_text", "market_news_html", "activity_url"],
        "body_text": walnut_email_text(
            greeting="Hello {{first_name}},",
            intro="Your Walnut daily watchlist digest for {{watchlist_name}} is ready.",
            sections=["Daily Digests", "{{summary}}", "{{items_text}}", "{{market_news_text}}"],
            cta_label="Review activity",
        ...
        "body_html": walnut_email_html(
            ...
            content_html=walnut_info_card("Activity summary", "{{summary}}") + "{{{items_html}}}" + "{{{market_news_html}}}",
            cta_label="Review activity",
            cta_url="activity_url",
            include_investment_disclaimer=True,
        ),
    },
    {
        ...
        "preheader": "Human-reviewed Walnut AI Growth drafts.",
        "variables": ["first_name", "digest_title", "summary", "items_text", "items_html", "digest_url"],
        "body_text": walnut_email_text(
            greeting="Hello {{first_name}},",
            intro="{{summary}}",
            sections=[
                "Review each draft before posting. Avoid spam and disclose affiliation when relevant.",
                "{{items_text}}",
            ],
    ...
    },
    {
        ...
        "body_text": walnut_email_text(
            ...
            sections=[
                ...
                f"Questions about billing? Contact {SUPPORT_EMAIL}.",
            ],
        ...
        "body_html": walnut_email_html(
            ...
            + walnut_info_card("Billing support", f"Questions about billing? Contact {SUPPORT_EMAIL}."),
            cta_label="View billing",
            cta_url="statement_url",
        ),
    },
...
LEGACY_DOMAIN_REPLACEMENTS = (
    ...
    ("no-reply@walnut-intel.com", ACCOUNT_FROM_EMAIL),
