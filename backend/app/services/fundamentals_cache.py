...
def normalize_fundamentals_payload(
    *,
    ...
    return {
        ...
        "forward_pe": _first_number(
            screener_row.get("forwardPE"),
            screener_row.get("forwardPe"),
            screener_row.get("forwardPERatio"),
            screener_row.get("forwardPriceToEarningsRatio"),
            quote_row.get("forwardPE"),
            quote_row.get("forwardPe"),
            quote_row.get("forwardPERatio"),
            metrics_row.get("forwardPE"),
            metrics_row.get("forwardPe"),
            metrics_row.get("forwardPERatio"),
        ),
        ...
        "eps_growth": _first_percent(
            screener_row.get("epsGrowth"),
            screener_row.get("epsGrowthTTM"),
            growth_row.get("epsgrowth"),
            growth_row.get("epsGrowth"),
            growth_row.get("growthEPS"),
            growth_row.get("growthEps"),
            growth_row.get("growthEPSDiluted"),
            growth_row.get("growthEpsDiluted"),
            growth_row.get("epsDilutedGrowth"),
            growth_row.get("epsdilutedGrowth"),
        ),
