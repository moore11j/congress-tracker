...
def refresh_ticker_seo_snapshot(db: Session, symbol: str) -> dict[str, Any]:
    ...
    return _upsert_snapshot(
        ...
        title=f"{normalized} Stock Analysis & Research | Walnut Markets",
        meta_description=f"Research {normalized} with fundamentals, technicals, Congress trades, insider activity, institutional filings and Walnut's Confirmation Score.",
        indexable=indexable,
        payload=payload,
