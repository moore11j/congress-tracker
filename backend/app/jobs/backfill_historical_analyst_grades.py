...
def backfill_historical_analyst_grades(
    *,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Backfill historical analyst grade events from FMP grades-historical.")
    ...
    print(
        json.dumps(
            backfill_historical_analyst_grades(
