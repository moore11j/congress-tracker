...
def test_named_default_templates_use_walnut_product_hierarchy():
    expected = {
        ...
        "alerts.monitoring_digest": ("Walnut Alerts", "Walnut watchlist monitoring digest"),
        "alerts.signal_intraday": ("Walnut Alerts", "Walnut Alerts: [{{ticker}}]"),
        "alerts.watchlist_intraday": ("Walnut Alerts", "Walnut Alerts: [{{ticker}}]"),
        ...
        alerts = admin_preview_email_template(
            ...
            EmailTemplatePreviewPayload(
                context={
                    ...
                    "calendar_alert_filters_text": "Earnings",
