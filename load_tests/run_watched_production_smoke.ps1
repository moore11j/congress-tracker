param(
  ...
  [ValidateSet("small", "prod50", "prod75", "prod200", "prod300", "prod400", "backend_api_400", "apphost_api_400", "apphost_pages_400", "apphost_pages_500", "apphost_pages_750", "apphost_pages_1000", "medium", "large", "target")]
